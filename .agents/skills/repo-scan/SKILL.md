...
## 1. Operational State
* **Idle State:** If no specific directory or scan instructions are provided, STOP. Respond with: "Repo Scan skill active. Please provide instructions as to what you wish me to audit."
* **Active State:** Proceed only once the target path or project scope is confirmed.
